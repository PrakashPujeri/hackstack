      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold">Overall Risk Status: Acceptable</h4>
              <p className="text-sm text-muted-foreground">
                Portfolio risk metrics are within acceptable thresholds. Current drawdown is below the maximum limit.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Maximum drawdown is approaching the 15% threshold. Monitor closely and consider reducing position sizes if drawdown increases.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Consider rebalancing portfolio to reduce concentration risk. Current volatility levels are optimal for the risk tolerance setting.
              </p>
            </div>
          </div>
        </CardContent>
